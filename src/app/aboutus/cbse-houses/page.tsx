...
const objectiveCardStyles = [
  { background: "#F4F0E7", border: "#173B6C", label: "#173B6C" },
  { background: "#41644A", border: "#41644A", label: "#41644A" },
  { background: "#F4F0E7", border: "#D39B44", label: "#D39B44" },
  { background: "#D39B44", border: "#D39B44", label: "#D39B44" },
];

const activityNumberColors = ["#173B6C", "#41644A", "#D39B44", "#D39B44"];
...
export default function PrimaryHousesPage() {
  ...
  return (
    <main className="min-h-screen bg-[#F4F0E7] text-[#173B6C]">
        ...
        <div className="mx-auto flex h-20 w-full max-w-[1510px] items-center justify-between px-5 sm:px-8 lg:px-10">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="flex flex-col leading-none">
              <span className="text-[18px] font-extrabold text-[#173B6C]">
                Sri Chaitanya
              </span>
              <span className="mt-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#173B6C]">
                CBSE Houses
              </span>
            </span>
          </Link>
          <Link
            href="/"
            className="inline-flex min-h-11 items-center rounded-full border border-[#F4F0E7] bg-white px-5 text-[14px] font-semibold text-[#173B6C] shadow-[0_10px_28px_rgba(23,59,108,0.08)] transition-all hover:-translate-y-0.5 hover:border-[#173B6C] hover:text-[#173B6C]"
          >
            Back to Home
          </Link>
        </div>
      ...
      <section className="relative isolate overflow-hidden bg-white pt-28">
        <div className="absolute inset-0 -z-10">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(23, 59, 108, 0.69)_0%,rgba(23, 59, 108, 0.67)_44%,rgba(23, 59, 108, 0.09)_100%)]" />
        </div>
        ...
        <div className="mx-auto w-full max-w-[1510px]">
          <div className="max-w-[820px]">
            <p
              data-section-reveal
              className="section-reveal-up text-[13px] font-extrabold uppercase tracking-[0.24em] text-[#173B6C]"
            >
              The Houses
            </p>
            <h2
              ...
              className="wave-reveal-heading mt-4 text-[38px] font-light leading-[1] tracking-[-0.05em] text-[#173B6C] sm:text-[56px]"
            >
          ...
          <div className="mt-14 grid gap-6 lg:grid-cols-2">
            {houses.map((house, index) => (
              <article
                key={house.name}
                data-section-reveal
                className="section-reveal-up group grid overflow-hidden rounded-[8px] border border-[#F4F0E7] bg-white shadow-[0_22px_55px_rgba(23,59,108,0.09)] sm:grid-cols-[0.72fr_1fr]"
              ...
              >
                ...
                <div className="flex min-h-[260px] flex-col justify-between p-8">
                  <div>
                    ...
                    <h3 className="mt-6 text-[30px] font-extrabold leading-tight tracking-[-0.04em] text-[#173B6C]">
                      {house.name}
                    </h3>
                    <p className="mt-4 text-[16px] leading-7 text-[#173B6C]">
                      {house.line}
                    </p>
                  </div>
                  <div
      ...
      <section className="bg-white px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
        <div className="mx-auto grid w-full max-w-[1510px] gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <p
              data-section-reveal
              className="section-reveal-up mt-6 max-w-[520px] text-[17px] leading-8 text-[#173B6C]"
            >
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {objectives.map((objective, index) => (
              <article
                key={objective}
                data-section-reveal
                className="section-reveal-up rounded-[8px] border p-7 shadow-[0_18px_42px_rgba(23,59,108,0.07)]"
                style={{
              ...
              >
                ...
                <h3 className="mt-5 text-[24px] font-extrabold leading-tight tracking-[-0.03em] text-[#173B6C]">
                  {objective}
                </h3>
              </article>
            ))}
      ...
      <section className="bg-[#F4F0E7] px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
        <div className="mx-auto w-full max-w-[1510px]">
          ...
          <div className="mt-14 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {activities.map((activity, index) => (
              <article
                key={activity}
                data-section-reveal
                className="campus-card-reveal overflow-hidden rounded-[8px] bg-white shadow-[0_20px_48px_rgba(23,59,108,0.09)]"
                style={{ animationDelay: `${index * 90}ms` }}
              >
                <div className="h-2 bg-[linear-gradient(90deg,#173B6C,#41644A,#D39B44,#D39B44)]" />
                <div className="p-7">
                  <span
                  ...
                  <h3 className="mt-5 text-[23px] font-extrabold leading-tight tracking-[-0.03em] text-[#173B6C]">
                    {activity}
                  </h3>
                </div>
              </article>
